=======================================================
Sale Order Type - Default Terms and conditions Template
=======================================================
...
.. |badge3| image:: https://img.shields.io/badge/github-solvosci%2Fslv--sale-lightgray.png?logo=github
    :target: https://github.com/solvosci/slv-sale/tree/14.0/sale_order_type_note_template
...
* In *Sale Order Type* settings menu, select a Terms and Conditions Template.
...
`feedback <https://github.com/solvosci/slv-sale/issues/new?body=module:%20sale_order_type_note_template%0Aversion:%2014.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `solvosci/slv-sale <https://github.com/solvosci/slv-sale/tree/14.0/sale_order_type_note_template>`_ project on GitHub.
