...
class Product(models.Model):
    ...
    sale_secondary_unit_qty_available = fields.Float(
        string="Quantity On Hand for Sale Sencondary Unit",
    ...
    has_sale_secondary_unit_qty_available = fields.Boolean(
        string="Has Quantity On Hand for Sale Sencondary Unit",
        compute="_compute_sale_secondary_unit_qty_available",
        compute_sudo=False,
        help="""
    ...
    def _compute_sale_secondary_unit_qty_available(self):
        ...
        """
        # TODO alternative code: adding sale_secondary_unit_qty_available computation to
        #      _compute_quantities method
